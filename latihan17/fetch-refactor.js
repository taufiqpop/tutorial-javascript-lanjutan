// FETCH
// fetch(resources, init); ==>> init optional
...
function getMovies (keyword) {
    return fetch('http://www.omdbapi.com/?apikey=e36e783b&s=' + keyword)
        .then(response => response.json())
...
function getMovieDetail (imdbid) {
    return fetch('http://www.omdbapi.com/?apikey=e36e783b&i=' + imdbid)
        .then(response => response.json())
        .then(m => m)
}
